...
public class History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Words.add(new Word(getApplicationContext().getString(R.string.Brandenburg_Gate),getApplicationContext().getString(R.string.Adress_Brandenburger_Tor), R.drawable.berlin_wall));
